...
import de.kp.ames.office.jod.util.OOException;


public abstract class AbstractOOConnection implements OOConnection, XEventListener {
    ...
    protected AbstractOOConnection(String connectionString) {
    ...
    public synchronized void connect() throws ConnectException {
    	...
    	try {
            ...
            throw new OOException("connection failed: "+ connectionString, exception);
        }
    }
    ...
    private Object getService(String className) {
        try {
            ...
            throw new OOException("could not obtain service: " + className, exception);
        }
    }
