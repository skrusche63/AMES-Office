...
public class DocumentFormat {
	...
	private Map<DocumentFamily,Map<String,Object>> exportOptions = new HashMap<DocumentFamily,Map<String,Object>>();
    private Map<String,Object> importOptions = new HashMap<String,Object>();
	...
	public void setExportOption(DocumentFamily family, String name, Object value) {
		...
		Map<String,Object> options = exportOptions.get(family);
        if (options == null) {
